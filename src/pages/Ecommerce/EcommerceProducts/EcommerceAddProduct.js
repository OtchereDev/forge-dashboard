...
const EcommerceAddProduct = (props) => {
  document.title = "Create Resource | Forge";
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      name: Yup.string().required("Please Enter a Resource Name"),
  ...
  console.log({ erreo: validation.errors });
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Create Resource" pageTitle="Resources" />
        ...
        <Row>
          <Col lg={12}>
            ...
            >
                ...
                <CardBody>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      {validation.errors.description &&
                      validation.touched.description ? (
                        <p className="error-message" type="invalid">
                          {validation.errors.description}
                        </p>
                      ) : null}
                    </div>
              ...
              <Card>
                {/* <CardHeader>
                  <h5 className="card-title mb-0">Resource Gallery</h5>
                </CardHeader> */}
                <CardBody>
                  <div className="mb-3">
                    <h5 className="fs-14 mb-1">File Type</h5>

                    <select
                      className="form-select mb-1"
                      aria-label="Default select example"
                      name="fileType"
                      value={validation.values.fileType || ""}
                      onBlur={validation.handleBlur}
                      onChange={validation.handleChange}
                      invalid={
                        validation.errors.fileType &&
                        validation.touched.fileType
                          ? true
                          : false
                      }
                    >
                  ...
                  <div>
                    <h5 className="fs-14 mb-1">Resource File</h5>
                          ...
                          >
                            <div className="p-2">
                              <Row className="align-items-center">
                                ...
                                <Col className="d-flex justify-content-end cursor-pointer text-danger fs-4">
                                  <i
                                    onClick={() => {
